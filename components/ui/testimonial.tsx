...
>(
  (
    ...
    const handleNext = () => {
      setExitX(-101); // Animate card moving left
      setTimeout(() => {
    ...
    const handlePrev = () => {
      setExitX(101); // Animate card moving right
      setTimeout(() => {
        setCurrentIndex(
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col items-center gap-4">
                  ...
                  <p className="text-center text-sm text-gray-600 dark:text-muted-foreground line-clamp-4">
