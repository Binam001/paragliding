...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
  ...
  return (
    <section
      className={`relative overflow-hidden bg-white text-gray-900 min-h-screen flex flex-col mt-16 ${className}`}
    >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      ).src = `https://placehold.co/400x400/334155/e2e8f0?text=Memory`;
                    }}
                  />
                </div>
              </div>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex-1 flex items-center justify-center mt-16">
        <div
