...
const AboutUsSection = () => {
  return (
    <section
      ...
      // }}
    >
      <div className="w-full h-full relative flex flex-col md:flex-row gap-4 md:gap-8 py-16">
        <div
          className="md:w-[25%] h-[70vh] relative flex flex-col items-center justify-center"
          // style={{ clipPath: "polygon(0 25%, 100% 0, 100% 100%, 0% 100%)" }}
        >
          <img src="/images/only-logo.png" alt="" className="" />
          <p className="text-9xl font-extrabold absolute -bottom-6 right-6 md:bottom-12 md:right-0 text-(--color-primary)">
            30<span className="text-lg text-black font-medium">years+</span>
          </p>
        </div>
        <div className="text-3xl md:text-5xl text-black h-full md:w-[75%] z-30 flex items-center">
