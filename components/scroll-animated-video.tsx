    ...
    >
      ...
      <div className="hsv-container" ref={headlineRef}>
        <div className="hsv-headline">
          {/* <h1 className="hsv-title text-blue-500">{title}</h1> */}
          <h1 className="text-blue-500 text-6xl font-extrabold mb-8">
            {title}
          </h1>
          {subtitle ? (
            <h2 className="text-gray-700 text-2xl mx-16">{subtitle}</h2>
          ) : null}
      ...
      <div
        ...
        data-sticky-scroll
        style={{ height: `${Math.max(50, scrollHeightVh)}vh` }}
      >
        <div className={`hsv-sticky ${sticky ? "is-sticky" : ""}`}>
          <div className="hsv-media" ref={containerRef}>
            ...
            <div className="flex flex-col justify-between" ref={overlayRef}>
              {overlay?.caption ? (
              ...
              <div className="text-5xl font-bold" ref={overlayContentRef}>
